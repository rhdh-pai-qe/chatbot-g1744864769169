...
3) Access the `workbench` named `chatbot-g1744864769169-notebook`.
...
5) In the terminal, run `cd chatbot-g1744864769169` to navigate to your sample app's directory.
